...
int main()
{
    ...
    pairs.insert({std::pair<state, symbol>("q1", "1"), commands[0]});
    pairs.insert({std::pair<state, symbol>("q1", "0"), commands[1]});
    pairs.insert({std::pair<state, symbol>("q1", "lambda"), commands[2]});
    pairs.insert({std::pair<state, symbol>("q2", "1"), commands[3]});
    pairs.insert({std::pair<state, symbol>("q2", "0"), commands[4]});
    pairs.insert({std::pair<state, symbol>("q2", "lambda"), commands[5]});
    pairs.insert({std::pair<state, symbol>("q3", "0"), commands[6]});
    pairs.insert({std::pair<state, symbol>("q3", "1"), commands[7]});
    pairs.insert({std::pair<state, symbol>("q3", "lambda"), commands[8]});
